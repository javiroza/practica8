...
# Títol del gràfic
set title "Autovectors amb potencial pertorbat"
...
# Plot 
plot "aux4.dat" index 0 using 1:2 with points t "{/Symbol F}(x) {/Symbol b}=0", \
"aux4.dat" index 1 using 1:2 with points t "{/Symbol F}(x) {/Symbol b}=1", \
"aux4.dat" index 2 using 1:2 with points t "{/Symbol F}(x) {/Symbol b}=5"
#pause -1
